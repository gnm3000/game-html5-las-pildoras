...
EntityPlayer = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/pj.png', 55, 69 ),	
	...
	init: function( x, y, settings ) {
		...
		this.addAnim( 'run', 0.07, [0,0,1,1,2,2,3,3] );
	...
	update: function() {
		...
		this.accel.x = accel;
                ...
                //si al truncar el numero es multiplo de 2
                timeInt = parseInt(this.timer.delta());
                ...
                if(timeInt==2){
                    ...
                    console.log("estas vivo.el timeInt es:"+timeInt);
...
//                    this.latidos = this.latidos +1;
//                    //alert("up");
//                    alert(this.latidos);
//                   //this.kill();
//                }
//		
		if( ig.input.pressed('latir') ) {
                   
			//this.latidos = this.latidos+1;
                        if(this.timer.delta()<0.5){
                            console.log("muerta por latir muy rapido.");
                            //alert("muy rapido. maximo 2 por segundo.");
                            this.kill();
                             window.location.reload();
                        }
                        this.timer.reset();
		...
		if( ig.input.pressed('up') ) {
			...
			alert(this.latidos+" latidos en "+this.timer.delta()+" segundos");
